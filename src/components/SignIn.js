      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            You're successfully signed in with {user.app_metadata?.provider === 'github' ? 'GitHub' : 'Google'}
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Welcome Back,
              <span className="text-gradient block">Hacker!</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Sign back into your HackerCard account to continue managing your hackathon finances.
            </p>
          </motion.div>
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Access your account with Google or GitHub
                </p>
              </div>
              ...
              <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get back to managing your virtual cards and team budgets instantly
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Continue managing budgets, assigning cards, and tracking spending
                    </p>
                  </div>
                </div>
              </div>
